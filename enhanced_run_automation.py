#!/usr/bin/env python3
"""
Enhanced Run Automation Script with Improved Blog Scraper

This script combines the improved blog scraper with the existing automation components
...
def run_enhanced_automation():
    """Run the complete AI news automation process with improved blog scraping"""
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Warning: feedparser library not installed. For better results, install it with:")
